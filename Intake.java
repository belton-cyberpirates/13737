...
public class Intake extends LinearOpMode {
    private Servo wrist = hardwareMap.get(Servo.class, Config.WRIST_NAME);
    private Servo clawLeft = hardwareMap.get(Servo.class, Config.CLAW_LEFT_NAME);
    private Servo clawRight = hardwareMap.get(Servo.class, Config.CLAW_RIGHT_NAME);
