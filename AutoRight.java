...
@Autonomous(name = "AutoRight"/*, preselectTeleOp = "xDriveCode"*/)
 ...
 */
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) { // <----------------------------------------------------------------
      ...
      // this will catch if AutoRight cant run
      telemetry.addData("Error", "Something went wrong running AutoRight");
      telemetry.update();
    }
